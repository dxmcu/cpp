...
int main(int argc, char **argv)
{
  ...
  ofs << "add_executable(${PROJECT_NAME} main.cpp)" << std::endl;
  ofs << "#target_sources(${PROJECT_NAME}  PRIVATE test.cpp)" << std::endl;
  ofs << "#target_link_libraries(${PROJECT_NAME} rt)" << std::endl;
  ofs << "#target_link_libraries(${PROJECT_NAME} pthread)" << std::endl;
