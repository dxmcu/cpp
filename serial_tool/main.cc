...
int main(int argc, char **argv)
{
    ...
    while (1)
    {
        ...
        {
            if (index ++ % 2 == 0) {
                char data[7] = {(char)0xFF, (char)0x01, (char)0x00, (char)0x10, (char)00, (char)0x64, (char)0x75};
                int nrecv = write(fd, data, 7);
                printf("send: %d\n", nrecv);
            } else {
                char data2[7] = {(char)0xFF, (char)0x01, (char)0x00, (char)0x08, (char)00, (char)0x64, (char)0x6D};
                int nrecv = write(fd, data2, 7);
                printf("send: %d\n", nrecv);
            } 
        }
    }
